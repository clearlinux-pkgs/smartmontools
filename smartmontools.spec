...
Source0  : https://github.com/smartmontools/smartmontools/archive/RELEASE_7_5/smartmontools-7.5.tar.gz
...
%prep
%setup -q -n smartmontools-RELEASE_7_5
cd %{_builddir}/smartmontools-RELEASE_7_5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746205811
...
cp %{_builddir}/smartmontools-RELEASE_7_5/smartmontools/COPYING %{buildroot}/usr/share/package-licenses/smartmontools/4cc77b90af91e615a64ae04893fdffa7939db84c || :
export GOAMD64=v2
pushd smartmontools
GOAMD64=v2
%make_install
