...
Version  : 7.3
Release  : 14
URL      : https://sourceforge.net/projects/smartmontools/files/smartmontools/7.3/smartmontools-7.3.tar.gz
Source0  : https://sourceforge.net/projects/smartmontools/files/smartmontools/7.3/smartmontools-7.3.tar.gz
Source1  : https://sourceforge.net/projects/smartmontools/files/smartmontools/7.3/smartmontools-7.3.tar.gz.asc
...
%prep
%setup -q -n smartmontools-7.3
cd %{_builddir}/smartmontools-7.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652245789
...
cp %{_builddir}/smartmontools-7.3/COPYING %{buildroot}/usr/share/package-licenses/smartmontools/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
